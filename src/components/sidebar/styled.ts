...
export const MenuItem = styled.div<{ $collapsed: boolean; $isHovered: boolean; $active: boolean }>(({ $collapsed, $isHovered, $active, theme }) => ({
  ...
  "&::before": $active
    ...
    : {},
  "&:hover": {
    backgroundColor: $active ? theme.colors.primaryLightHover : theme.colors.surfaceHover,
...
export const ToggleButton = styled.button<{ $collapsed: boolean; $isHovered: boolean }>(({ $collapsed, $isHovered, theme }) => ({
  width: "100%",
  backgroundColor: "transparent",
  border: "none",
  color: theme.colors.textSecondary,
